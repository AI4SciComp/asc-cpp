# ADR 0018: pre-1.0 compatibility and release evidence
...
- architecture baseline has no library release and exports no production target.
- Earliest lines are: core `0.1.x`; independent foundations `0.2.x`; dense
  ...
  sparse/random CUDA `0.7.x`; release-hardening line `0.9.x`.
