...
Therefore this branch carries the complete staged Milestone 0 candidate as an
unchanged predecessor layer. It consists of 288 paths based on clean, current
`main` at `33b261ea33616a6395c4ad3b20646093103344f7`, with no unstaged
changes at advancement. Milestone 1 work must not rewrite its approved
