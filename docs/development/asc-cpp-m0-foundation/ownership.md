...
| --- | --- | --- | --- |
| Lead architect/integrator | `CMakeLists.txt`, `CMakePresets.json`, `cmake/**`, `.github/workflows/ci.yml`, `docs/development/asc-cpp-m0-foundation/{milestone-contract,ownership,publication-checkpoint-b}.md`, final integration fixes | entire workspace | all shared root build/package/CI files |
