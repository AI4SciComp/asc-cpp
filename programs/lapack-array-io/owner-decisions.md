...
| Pinned Reference GEEQUB LP64 radix power evaluation | S/D/C/Z nonzero3x2 Sample at2^-140single/2^-1050double, bothlayouts. Require INFO0 and unchanged16epsilon scale/statistic equations; LP64returnsINFO1,R0,AMAX0 with C/ratios untouched. Four processes88assertions/four scalar fixtures/eightlayout executions share one cause. Direct/disassembly evidence already proves libgcc positive-power-before-reciprocal intermediate overflow; GEEQUbothABIs and trueILP64GEEQUB pass. | Preserve the mathematical gate. A separately authorized provider/compiler-runtime decision or explicit first-party radix strategy is needed; no provider/runtime/FP change or waiver is inferred. [Exact continued review](lu-equilibration-review.md#master-continuation-normalized-geequgeequb-modes). Independent engineering continues. |
| Pinned Reference GERFS weighted inverse estimation | S/D/C/Z scalar A=AF=B=minnormal/1024, pivot1, initialX.75; N/T/C, all-column/all-row layouts. X1 and guardedBERR pass; required finite FERR≈2048 within64epsilon fails with INFO0: realInf, complexN NaN, complexT/C Inf. Four processes72assertions, four scalar fixtures24executions, one unscaledGETRS-before-smallweight cause. Direct pinned provider reproduces bothABIs;2minnormal control passes. | Preserve the finite-estimate gate. A separately authorized provider or scale-safe first-party estimation strategy is needed; PPSVX authority does not transfer. [Exact GERFS disposition](lu-refinement-review.md#numerical-disposition). Independent shared/concurrency/installed work and other families continue. |
| GESVX inherits the GECON and GERFS estimation causes | Same scalarA=AF=B=minnormal/1024,pivot1,FACTN/F,N/T/C,bothlayouts. Required exactX1/RCOND1/INFO0/finiteestimates; ASC/direct giveX1,RCOND0,INFO2,growth1,guardedBERR,nonfiniteFERR. Four processes240assertions, four scalar fixtures48executions, two already listed causes. ExplicitE and2minnormal control pass. | Apply the separate condition and weighted-inverse decisions above to an explicitly approved GESVX strategy if authorized. Preserve both failing requirements; PPSVX authority does not transfer and no silentE fallback is allowed. [Exact GESVX continuation](lu-driver-review.md#numerical-disposition). Independent engineering continues. |
