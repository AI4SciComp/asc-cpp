...
foreach(_file IN LISTS _public_files)
  ...
  if(_contents MATCHES "#[ \t]*include[ \t]*[<\"](cuda|hip|sycl|CL|mkl|cublas|cusparse|rocblas|rocsparse)[/\\.>]")
    message(FATAL_ERROR "Provider header leaks into provider-free API: ${_file}")
  endif()
  if(_contents MATCHES "namespace[ \t]+asc::")
    message(FATAL_ERROR "Public APIs must use the flat asc namespace: ${_file}")
  endif()
endforeach()
