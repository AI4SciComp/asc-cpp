...
namespace {
using asc_aasen_two_stage_fault_test::Fault;
...
void Invoke(lapack_int n, T* tb, lapack_int ltb, lapack_int lwork,
...
bool SingularInput(Fault fault) {
  return fault == Fault::kRealSingular || fault >= Fault::kNonzeroWitness;
}
}  // namespace asc_aasen_two_stage_fault_test
// Output injection follows a real call to the exact inventoried routine.
// NOLINTBEGIN(bugprone-reserved-identifier)
extern "C" {
decltype(LAPACK_ssytrf_aa_2stage_base) __real_ssytrf_aa_2stage_;
void __wrap_ssytrf_aa_2stage_(const char* tri, const lapack_int* n, float* a,
                              const lapack_int* lda, float* tb,
                              const lapack_int* ltb, lapack_int* pivots,
                              lapack_int* band_pivots, float* work,
                              const lapack_int* lwork, lapack_int* info,
                              std::size_t length) {
  Invoke(*n, tb, *ltb, *lwork, pivots, band_pivots, info,
         [&](lapack_int* p, lapack_int* q, lapack_int* native_info) {
           __real_ssytrf_aa_2stage_(tri, n, a, lda, tb, ltb, p, q, work, lwork,
                                    native_info, length);
         });
}
static_assert(std::is_same_v<decltype(LAPACK_ssytrf_aa_2stage_base),
                             decltype(__wrap_ssytrf_aa_2stage_)>);
decltype(LAPACK_dsytrf_aa_2stage_base) __real_dsytrf_aa_2stage_;
void __wrap_dsytrf_aa_2stage_(const char* tri, const lapack_int* n, double* a,
                              const lapack_int* lda, double* tb,
                              const lapack_int* ltb, lapack_int* pivots,
                              lapack_int* band_pivots, double* work,
                              const lapack_int* lwork, lapack_int* info,
                              std::size_t length) {
  Invoke(*n, tb, *ltb, *lwork, pivots, band_pivots, info,
         [&](lapack_int* p, lapack_int* q, lapack_int* native_info) {
           __real_dsytrf_aa_2stage_(tri, n, a, lda, tb, ltb, p, q, work, lwork,
                                    native_info, length);
         });
}
static_assert(std::is_same_v<decltype(LAPACK_dsytrf_aa_2stage_base),
                             decltype(__wrap_dsytrf_aa_2stage_)>);
decltype(LAPACK_csytrf_aa_2stage_base) __real_csytrf_aa_2stage_;
void __wrap_csytrf_aa_2stage_(const char* tri, const lapack_int* n,
                              lapack_complex_float* a, const lapack_int* lda,
                              lapack_complex_float* tb, const lapack_int* ltb,
                              lapack_int* pivots, lapack_int* band_pivots,
                              lapack_complex_float* work,
                              const lapack_int* lwork, lapack_int* info,
                              std::size_t length) {
  Invoke(*n, tb, *ltb, *lwork, pivots, band_pivots, info,
         [&](lapack_int* p, lapack_int* q, lapack_int* native_info) {
           __real_csytrf_aa_2stage_(tri, n, a, lda, tb, ltb, p, q, work, lwork,
                                    native_info, length);
         });
}
static_assert(std::is_same_v<decltype(LAPACK_csytrf_aa_2stage_base),
                             decltype(__wrap_csytrf_aa_2stage_)>);
decltype(LAPACK_zsytrf_aa_2stage_base) __real_zsytrf_aa_2stage_;
void __wrap_zsytrf_aa_2stage_(const char* tri, const lapack_int* n,
                              lapack_complex_double* a, const lapack_int* lda,
                              lapack_complex_double* tb, const lapack_int* ltb,
                              lapack_int* pivots, lapack_int* band_pivots,
  ...
  Invoke(*n, tb, *ltb, *lwork, pivots, band_pivots, info,
         [&](lapack_int* p, lapack_int* q, lapack_int* native_info) {
           __real_zsytrf_aa_2stage_(tri, n, a, lda, tb, ltb, p, q, work, lwork,
                                    native_info, length);
         });
}
static_assert(std::is_same_v<decltype(LAPACK_zsytrf_aa_2stage_base),
                             decltype(__wrap_zsytrf_aa_2stage_)>);
decltype(LAPACK_chetrf_aa_2stage_base) __real_chetrf_aa_2stage_;
void __wrap_chetrf_aa_2stage_(const char* tri, const lapack_int* n,
                              lapack_complex_float* a, const lapack_int* lda,
                              lapack_complex_float* tb, const lapack_int* ltb,
                              lapack_int* pivots, lapack_int* band_pivots,
                              lapack_complex_float* work,
  ...
  Invoke(*n, tb, *ltb, *lwork, pivots, band_pivots, info,
         [&](lapack_int* p, lapack_int* q, lapack_int* native_info) {
           __real_chetrf_aa_2stage_(tri, n, a, lda, tb, ltb, p, q, work, lwork,
                                    native_info, length);
         });
}
static_assert(std::is_same_v<decltype(LAPACK_chetrf_aa_2stage_base),
                             decltype(__wrap_chetrf_aa_2stage_)>);
decltype(LAPACK_zhetrf_aa_2stage_base) __real_zhetrf_aa_2stage_;
void __wrap_zhetrf_aa_2stage_(const char* tri, const lapack_int* n,
                              lapack_complex_double* a, const lapack_int* lda,
                              lapack_complex_double* tb, const lapack_int* ltb,
                              lapack_int* pivots, lapack_int* band_pivots,
                              lapack_complex_double* work,
  ...
  Invoke(*n, tb, *ltb, *lwork, pivots, band_pivots, info,
         [&](lapack_int* p, lapack_int* q, lapack_int* native_info) {
           __real_zhetrf_aa_2stage_(tri, n, a, lda, tb, ltb, p, q, work, lwork,
                                    native_info, length);
         });
}
static_assert(std::is_same_v<decltype(LAPACK_zhetrf_aa_2stage_base),
                             decltype(__wrap_zhetrf_aa_2stage_)>);
}  // extern "C"
