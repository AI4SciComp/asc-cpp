...
struct Native<float, false> {
  static constexpr auto kTrf = LAPACK_ssytrf_rook_base;
  static constexpr auto kTf2 = ssytf2_rook_;
  static constexpr auto kTrs = LAPACK_ssytrs_rook_base;
};
template <>
struct Native<double, false> {
  static constexpr auto kTrf = LAPACK_dsytrf_rook_base;
  static constexpr auto kTf2 = dsytf2_rook_;
  static constexpr auto kTrs = LAPACK_dsytrs_rook_base;
};
template <bool Hermitian>
struct Native<std::complex<float>, Hermitian> {
  static constexpr auto kTrf =
      Hermitian ? LAPACK_chetrf_rook_base : LAPACK_csytrf_rook_base;
  static constexpr auto kTf2 = Hermitian ? chetf2_rook_ : csytf2_rook_;
  static constexpr auto kTrs =
      Hermitian ? LAPACK_chetrs_rook_base : LAPACK_csytrs_rook_base;
};
template <bool Hermitian>
struct Native<std::complex<double>, Hermitian> {
  static constexpr auto kTrf =
      Hermitian ? LAPACK_zhetrf_rook_base : LAPACK_zsytrf_rook_base;
  static constexpr auto kTf2 = Hermitian ? zhetf2_rook_ : zsytf2_rook_;
  static constexpr auto kTrs =
      Hermitian ? LAPACK_zhetrs_rook_base : LAPACK_zsytrs_rook_base;
};
...
void FactorCase(TestContext& test, const asc::ReferenceLapackProvider& provider,
  ...
  if (mathematical) {
    // For scale*I, the exact rook factors are D=scale*I, U/L=I and identity
