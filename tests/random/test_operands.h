#ifndef ASC_TESTS_RANDOM_TEST_OPERANDS_H_
#define ASC_TESTS_RANDOM_TEST_OPERANDS_H_
...
/// Structural operand used to verify that Random revalidates foreign views.
template <typename Element, typename Mapping>
class RandomTestOperand {
 public:
  ...
  RandomTestOperand(DataHandle data, Mapping mapping, extent_t available_span,
...
#endif  // ASC_TESTS_RANDOM_TEST_OPERANDS_H_
