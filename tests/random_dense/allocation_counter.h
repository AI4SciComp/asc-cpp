#ifndef ASC_TESTS_RANDOM_DENSE_ALLOCATION_COUNTER_H_
#define ASC_TESTS_RANDOM_DENSE_ALLOCATION_COUNTER_H_
...
#endif  // ASC_TESTS_RANDOM_DENSE_ALLOCATION_COUNTER_H_
