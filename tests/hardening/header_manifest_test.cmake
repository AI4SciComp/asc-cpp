...
if(NOT _all_header_count EQUAL 133)
  message(FATAL_ERROR
    "Independent source-header oracle must contain 133 headers; got "
    "${_all_header_count}"
  )
endif()
...
if(NOT "${_source_headers}" STREQUAL "${_all_headers}")
  message(FATAL_ERROR
    "Source public-header tree differs from the frozen 133-header oracle.\n"
