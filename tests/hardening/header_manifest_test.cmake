...
set(_lapack_entries
  ...
  "dense_lapack|asc/dense/providers/lapack_indefinite_packed.h"
  "dense_lapack|asc/dense/providers/lapack_indefinite_packed_inverse.h"
  "dense_lapack|asc/dense/providers/lapack_indefinite_packed_condition.h"
  "dense_lapack|asc/dense/providers/lapack_indefinite_packed_refinement.h"
  "dense_lapack|asc/dense/providers/lapack_indefinite_packed_solve.h"
...
if(NOT _all_header_count EQUAL 163)
  message(FATAL_ERROR
    "Independent source-header oracle must contain 163 headers; got "
    "${_all_header_count}"
  )
endif()
...
if(NOT "${_source_headers}" STREQUAL "${_all_headers}")
  message(FATAL_ERROR
    "Source public-header tree differs from the frozen 163-header oracle.\n"
