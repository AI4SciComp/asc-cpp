#ifndef ASC_TESTS_ARRAY_TEST_RESOURCES_H_
#define ASC_TESTS_ARRAY_TEST_RESOURCES_H_
...
class ArrayCountingMemoryResource final : public MemoryResource {
 public:
  explicit ArrayCountingMemoryResource(
...
class ArrayFailingMemoryResource final : public MemoryResource {
 public:
...
#endif  // ASC_TESTS_ARRAY_TEST_RESOURCES_H_
