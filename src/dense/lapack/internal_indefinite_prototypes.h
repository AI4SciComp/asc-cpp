#ifndef ASC_DENSE_LAPACK_INTERNAL_INDEFINITE_PROTOTYPES_H_
#define ASC_DENSE_LAPACK_INTERNAL_INDEFINITE_PROTOTYPES_H_
...
// under p05-indefinite-01; no new Fortran compilation path is introduced.
...
extern "C" {
void ssytf2_(char* uplo, lapack_int* n, float* matrix, lapack_int* lda,
             lapack_int* pivots, lapack_int* info, std::size_t uplo_length);
void dsytf2_(char* uplo, lapack_int* n, double* matrix, lapack_int* lda,
             lapack_int* pivots, lapack_int* info, std::size_t uplo_length);
void csytf2_(char* uplo, lapack_int* n, lapack_complex_float* matrix,
             lapack_int* lda, lapack_int* pivots, lapack_int* info,
             std::size_t uplo_length);
void zsytf2_(char* uplo, lapack_int* n, lapack_complex_double* matrix,
             lapack_int* lda, lapack_int* pivots, lapack_int* info,
             std::size_t uplo_length);
void chetf2_(char* uplo, lapack_int* n, lapack_complex_float* matrix,
             lapack_int* lda, lapack_int* pivots, lapack_int* info,
             std::size_t uplo_length);
void zhetf2_(char* uplo, lapack_int* n, lapack_complex_double* matrix,
             lapack_int* lda, lapack_int* pivots, lapack_int* info,
             std::size_t uplo_length);
}

#endif  // ASC_DENSE_LAPACK_INTERNAL_INDEFINITE_PROTOTYPES_H_
