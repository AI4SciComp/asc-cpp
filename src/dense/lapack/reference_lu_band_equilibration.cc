...
struct Native<float> {
  ...
  static constexpr std::string_view kName = "sgbequ";
  static constexpr auto kExecute = LAPACK_sgbequ;
};
template <>
struct Native<double> {
  static constexpr auto kScalar = LapackScalarKind::kF64;
  static constexpr std::string_view kName = "dgbequ";
  static constexpr auto kExecute = LAPACK_dgbequ;
};
template <>
struct Native<std::complex<float>> {
  static constexpr auto kScalar = LapackScalarKind::kC64;
  static constexpr std::string_view kName = "cgbequ";
  static constexpr auto kExecute = LAPACK_cgbequ;
};
template <>
struct Native<std::complex<double>> {
  static constexpr auto kScalar = LapackScalarKind::kC128;
  static constexpr std::string_view kName = "zgbequ";
  static constexpr auto kExecute = LAPACK_zgbequ;
};
...
Result<LapackWorkspacePlan> QueryGbequWorkspace(
    const ReferenceLapackProvider& provider,
...
Status Gbequ(const ReferenceLapackProvider& provider,
             ReferenceGeneralBandView<const float> matrix,
             DenseBlasVectorView<float> row_scales,
             DenseBlasVectorView<float> column_scales,
